...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@sampleclub.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+254 (000) 000-000</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SAMPLE <span>CLUB</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">sample club</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							<span class="cbp-ig-icon w3_cube"></span>
							<h4 class="cbp-ig-title">TOWN VIEW BALCONY</h4>
							<span class="cbp-ig-category">sample club</span>
						</div>
					</li>
					<li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our sample club</h3> 
						   <p class="about-para-w3ls"><!--Lorem Ipsum is simply dummy text of the printing and typesetting industry.Sed tempus vestibulum lacus blandit faucibus. Nunc imperdiet, diam nec rhoncus ullamcorper, nisl nulla suscipit ligula, at imperdiet urna --> Some text description of the club...</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p><!-- Lorem ipsum dolor sit amet, ut magna aliqua --> Some text here... </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>Some text description of the clubs' accommodation...</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>Some text description of the clubs' restaurant...</p>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Buda Boss</h4>
							<span>Manager</span>
							<p><!--Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis.Lorem ipsum dolor --> Some text here...</p>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Customer's story goes here.... </p>
								<h5>@Party Animal</h5>
								<p>Kerugoya</p>
							</div>
							<div class="clearfix"> </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+254 (07)00-000-000</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SAMPLECLUB.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> New Kenya Road, Kirinyaga, Kenya</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2025 SAMPLE CLUB . All Rights Reserved  <br>Developed at <a href="index.php">gitslab&copy;</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
